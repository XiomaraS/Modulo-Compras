...
namespace OrdenesdeCompraWerner
{
    ...
    {
        string MyConnection2 = "Driver ={ MySQL ODBC 3.51 Driver }; Dsn=hotelsancarlos; Dsn=hotelsancarlos; Database=hotelSanCarlos;; ";
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                string Query = "insert into hotelSanCarlos.controldevolucion(`idcontroldevolucion`,`id_oc`,`devoluacion_autorizada`,`descripcion`) values('" + Globales2.nodevo + "','" + Globales2.oc + "','1','" + descripcion + "');";
