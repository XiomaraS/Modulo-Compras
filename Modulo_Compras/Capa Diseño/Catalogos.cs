...
namespace OrdenesdeCompraWerner
{
    public partial class Catalogos : Form
    {
        ...
        private void comboBox3_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            OdbcConnection conector = new OdbcConnection("Driver ={ MySQL ODBC 3.51 Driver }; Dsn=hotelsancarlos; Database=hotelSanCarlos; ");
            conector.Open();
        ...
        private void Catalogos_Load(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                sentencia.CommandText = "SELECT * from hotelSanCarlos.departamento";
            ...
            try
            {
                ...
                OdbcCommand sentencia = new OdbcCommand();
                sentencia.Connection = conector;
                sentencia.CommandText = "SELECT * from hotelSanCarlos.productos";
            ...
            try
            {
                ...
                OdbcCommand sentencia = new OdbcCommand();
                sentencia.Connection = conector;
                sentencia.CommandText = "SELECT * from hotelSanCarlos.proveedores";
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                string Query = "insert into hotelSanCarlos.ORDENESDECOMPRA(id_oc,idProveedores,idProducto,cantidad,categoria,fecha_prevista_de_recibido) values('" + Globales.oc + "','" + this.comboBox2.Text + "','" + this.comboBox3.Text + "','" + Globales.cantidad + "','" + Globales.departamento + "','" + fecha + "');";
