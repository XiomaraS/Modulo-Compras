    ...
    public partial class AlmacenarOCRealizadas : Form
    {
        ...
        private void AlmacenarOCRealizadas_Load(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                sentencia.CommandText = "SELECT id_oc from hotelSanCarlos.ORDENESDECOMPRA";
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                string Query = "insert into hotelSanCarlos.controldemoras(id_oc,fecha_entregada,demora) values('" + this.comboBox1.Text + "','" + fecha + "','" + dias + "');";
